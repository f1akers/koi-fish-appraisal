...
export function ResultsPanel({
  ...
  const patternDisplay =
    result.pattern_name.charAt(0).toUpperCase() + result.pattern_name.slice(1);
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="grid lg:grid-cols-5 gap-6 mb-8">
        ...
        {/* Metrics Grid */}
        <div
          className={`grid grid-cols-1 sm:grid-cols-3 gap-4 ${imagePreview ? "lg:col-span-3" : "lg:col-span-5"}`}
        >
          ...
          <div className="animate-fade-in animate-delay-300">
            <MetricCard
              ...
              subtitle={
                result.symmetry_score >= 0.8
                  ? "Excellent"
                  : result.symmetry_score >= 0.6
                    ? "Good"
                    : "Fair"
              }
              variant={
          ...
          <div className="animate-fade-in animate-delay-400">
            <MetricCard
              title="Color Score"
              value={`${(result.color_score * 100).toFixed(0)}%`}
              subtitle={
                result.color_score >= 0.8
                  ? "Excellent"
                  : result.color_score >= 0.6
                    ? "Good"
                    : "Fair"
              }
              variant={
          ...
          <div className="animate-fade-in animate-delay-400">
            <MetricCard
              title="Overall Score"
              value={`${(result.overall_score * 100).toFixed(0)}%`}
              subtitle={
      ...
      <div className="bg-gradient-to-br from-gray-50 to-slate-100 rounded-2xl p-6 mb-8 animate-fade-in animate-delay-300">
        ...
        <ColorDistribution colorProportions={result.color_proportions} />
      </div>
